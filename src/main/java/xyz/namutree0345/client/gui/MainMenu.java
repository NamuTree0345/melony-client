package xyz.namutree0345.client.gui;
...
public class MainMenu extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("melony/logo.png"));
        int logoWidthImage = 800 / 15;
        Gui.drawScaledCustomSizeModalRect(sr.getScaledWidth() / 2 - logoWidthImage / 2, rectY, 0, 0, 800, 800, 800 / 15, 800 / 15, 800, 800);
